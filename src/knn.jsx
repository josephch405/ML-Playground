	...
	info(){
		return this.generateInfo(
			...
			["A simple and straightforward algorithm. The underlying assumption is that datapoints close to each other share the same label.",
				...
				"Note that distance can be defined different ways, such as Manhattan (sum of all features), Euclidean (geometric distance), p-norm distance...typically Euclidean is used, but Manhattan can be faster and thus preferable."],
