...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__knn__ = __webpack_require__(11);
...
var knn = {
	...
	indexFromName: function (n) {
		for (var i = 0; i < setData.size; i++) {
			if (this.setData.name + "" == n + "") return i;
		}
		return null;
	},
...
/* unused harmony default export */ var _unused_webpack_default_export = knn;
